...
## OUTPUT
![image](https://github.com/user-attachments/assets/b37ac0f1-0765-4b92-b24b-db372aeada13)


## RESULT
Thus the Python program to **count the number of triangles** present in an **undirected graph** using matrix operations has executed successfully.
