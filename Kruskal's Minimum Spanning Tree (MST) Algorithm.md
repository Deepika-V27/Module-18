...
## OUTPUT
![image](https://github.com/user-attachments/assets/bf8aa627-c3b7-424d-8572-27acc31ecea6)


## RESULT
Thus the Python program for **Kruskal's algorithm** to find the Minimum Spanning Tree (MST) of a given connected, undirected, and weighted graph has executed successfully.
